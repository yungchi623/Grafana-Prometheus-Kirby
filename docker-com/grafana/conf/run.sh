...
: "${GF_SMTP_ENABLED:=true}"　　　　#啓用smtp配置
: "${GF_SMTP_HOST:=smtp.gmail.com:465}"　　　　#smtp服務器的地址：端口
: "${GF_SMTP_USER:=servergazer@n-warp.com}"　　　　#認證的郵箱賬戶
: "${GF_SMTP_PASSWORD:=1qw23eR$}"　　　　#郵箱密碼（注：163使用的客戶端授權碼作爲用戶密碼）
: "${GF_SMTP_FROM_ADDRESS:=servergazer@n-warp.com}"　　　　#郵箱發件人地址，注意！此處一定要和上面的郵箱認證賬戶保持一致。
